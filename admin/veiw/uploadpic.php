<?php
    ...
    include_once("../includes/addpic.php");
?>
...
<div class="container">
  <form enctype="multipart/form-data" action="../includes/addpic.php" method="POST">
    ...
    <div class="form-group">
      <textarea name="description" id="" cols="112" rows="8" placeholder="Description" class="mt-3"></textarea>
    </div>
    <div class="form-group">
