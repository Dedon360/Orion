<?php
  ...
  if(isset($_GET['id'])){
    ...
    $query = "SELECT * FROM order_tb WHERE id = '$id'";
  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    ...
    <section id="book-a-table" class="book-a-table mt-5">
        <div class="container" data-aos="fade-up">
          ...
          <div class="mt-5 php-email-form" data-aos="fade-up" data-aos-delay="100">
            <div class="row">
              ...
              <div class="col-lg-4 col-md-6 form-group mt-3 mt-md-0">
                <input type="number" class="form-control" name="phone" id="phone" placeholder="Your Phone" data-rule="minlen:4">
                <div class="validate"></div>
              </div>
              <div class="col-md-6 col-md-6 form-group mt-3">
            ...
            <div class="text-center"><button name="submit"  class="btn book-a-table-btn" onclick="savetable()" value="index">Submit</button></div>
          </div>
          <div id="msg"></div>
        </div>
...
<script>
  ...
  function savetable(){
      ...
      $.ajax({
        url:'../admin/includes/booking.php',
        type: 'POST',
        cache: false, 
        contentType: false,
        processData: false,
